            ...
            <div class="col-md-6 border-end border-white border-opacity-10 pe-md-4">
                <form method="POST">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-5"><label class="small opacity-50 mb-1">จังหวัด</label><input type="text" name="province" class="form-control" value="<?= htmlspecialchars($order['province']) ?>" <?= !in_array($order['status'], ['pending', 'processing']) ? 'disabled' : '' ?>></div>
            ...
            <table class="table table-dark small">
                ...
                <tbody>
                    ...
                    <tr class="align-middle border-bottom border-white border-opacity-10">
                        <td class="d-flex align-items-center"><img src="images/<?= htmlspecialchars($item['variant_image'] ?: $item['p_image']) ?>" width="50" height="50" class="rounded me-3 shadow-sm" style="object-fit:cover;"><span><b class="text-white"><?= htmlspecialchars($item['p_name']) ?></b></span></td>

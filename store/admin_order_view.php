...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ajax_status'])) {
    ...
    // อัปเดตสถานะ (สะกดตรงตามที่กำหนดไว้: processing, shipped, delivered)
        ...
        <div class="col-md-8">
            <div class="glass-card mb-4">
                <table class="table table-dark table-hover mb-0">
                    <thead>
                        <tr class="small text-white-50"><th>สินค้า</th><th class="text-center">จำนวน</th><th class="text-end">รวม</th></tr>
                    </thead>
                    <tbody>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="2" class="text-end fw-bold pt-3">ยอดรวมสุทธิ:</td>
